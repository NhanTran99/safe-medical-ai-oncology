...
| Field | Value |
|-------|-------|
| Knowledge Passport ID | KP-PP-0020 |
| Population Package ID | PP-0020 |
| Clinical Knowledge Object | CKO-PP-0020 |
| Title | HER2-targeted Therapy for Gastric Adenocarcinoma |
...
| Knowledge Scope | Treatment Modality |
...
HER2-targeted therapy is an important precision treatment option for patients with HER2-positive gastric adenocarcinoma and is considered during treatment planning after biomarker testing.
...
- Foundational educational response regarding HER2-targeted therapy.

## Secondary Runtime Role

- Prerequisite knowledge retrieval before individual HER2-targeted drug Population Packages.
...
- Who can receive HER2-targeted therapy?
- Is HER2-targeted therapy the same as chemotherapy?
- What are the benefits of HER2-targeted therapy?
- Does everyone with HER2-positive cancer receive the same treatment?
...
HER2-targeted therapy is one of the central concepts in precision oncology and directly connects biomarker testing with treatment selection.
...
| PP | Relationship |
|----|--------------|
| PP-0013 | HER2-targeted therapy is a subtype of targeted therapy |
| PP-0016 | HER2 testing determines eligibility for HER2-targeted therapy |
| PP-0015 | Biomarker testing provides the foundation for treatment selection |
| Future PP | Trastuzumab |
...
- Individual HER2-targeted medicines
- Drug pharmacology
- Drug dosing
- Infusion procedures
- Cardiac monitoring
...
|----------|------|-------------|
| 1.0.0 | 2026-08-04 | Initial Knowledge Passport for HER2-targeted Therapy for Gastric Adenocarcinoma |
...
- NCCN substantially revises HER2-targeted therapy recommendations.
- New HER2-targeted therapies become standard of care.
...
This Knowledge Passport is the official governance metadata for **PP-0020 — HER2-targeted Therapy for Gastric Adenocarcinoma** and conforms to the **Gold Population Package Specification v1.0**.