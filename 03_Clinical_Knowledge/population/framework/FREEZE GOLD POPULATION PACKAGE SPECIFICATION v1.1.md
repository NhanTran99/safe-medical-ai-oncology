...
This specification defines the official structure, writing standard, governance
requirements, and quality criteria for every Population Package produced during
the Population Knowledge Execution phase.

After this specification is LOCKED:

- Population Package format SHALL NOT change.
- Canonical artifact structure SHALL remain stable.
- Only clinical content may evolve unless this specification is explicitly
  superseded by a future Locked Governance Decision.

The canonical Gold Population Package consists of exactly four artifacts:
...
The Population Package is a Knowledge Product, not an execution log.

Gold Reference Packages establish the minimum production depth for all future
Population Packages.

Additional depth is permitted when clinically justified and evidence-supported,
but future packages SHALL NOT be materially shallower than the approved Gold
Reference standard.
...
# 1A. Gold Depth Integrity

Gold Reference Packages establish the minimum production depth.

Future Population Packages SHALL NOT be compacted or materially reduced in depth relative to approved Gold References.

Additional depth is permitted when supported by clinical scope and evidence.

Additional depth SHALL NOT:
- introduce unsupported clinical claims;
- expand the approved Population Package scope;
- duplicate substantive ownership of an adjacent Population Package.

Only clinical content may change between Population Packages.

Gold depth applies to:

- Population Package structure;
- Clinical Knowledge Object depth;
...
- clinical reasoning and scope documentation.

The Gold Reference establishes the minimum acceptable level of completeness and detail.

Only clinical content may change between Population Packages.

Structure, production depth, and quality standard SHALL remain consistent unless this specification is explicitly superseded by a future Locked Governance Decision.
