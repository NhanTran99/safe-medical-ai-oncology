...
This document defines the Runtime Evidence Package used by the Safe Medical AI
System.

The Runtime Evidence Package is distinct from the Primary Evidence Package
stored as Artifact 03 within a Gold Population Package.

The Primary Evidence Package is a governed Population Package artifact that
documents the evidence basis for a clinical knowledge product.

The Runtime Evidence Package is a runtime retrieval output assembled from
governed Clinical Knowledge Objects for downstream response generation.

This specification governs the Runtime Evidence Package and its interface
between the Retrieval Layer and Prompting Strategy.

The two artifacts SHALL NOT be treated as interchangeable.
