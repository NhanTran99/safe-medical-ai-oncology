...
The Runtime Evidence Package is the runtime evidence-transfer object produced
by the Retrieval Layer.

It is distinct from the Primary Evidence Package stored as Artifact 03 within
a Gold Population Package.
...
- Retrieval Layer
- Knowledge Registry
- Primary Evidence Package repository artifacts

is prohibited.

Response Generation consumes the Runtime Evidence Package rather than directly
reading repository knowledge assets.
