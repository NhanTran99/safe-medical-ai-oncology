...
Every Population Package contains three governed assets:

Clinical Knowledge Object (CKO)
Knowledge Passport (KP)
Primary Evidence Package (EP)
...
The Population Package is the smallest independently governed operational unit within the repository.
