**Project Repository Map v1.1 / handover context** cho các thread sau.
Tại thời điểm **kết thúc Phase 3 / chuẩn bị Phase 4**, tôi đề nghị xem bản dưới đây như 
Mục tiêu của bản này là: **một thread mới chỉ cần đọc map này là hiểu project đang có gì, file nào là SSOT, file nào là working material, và khi sang phase mới cần update ở đâu.**
...
Phase 3 substantive production is complete for the Core Gastric Cancer
Population Wave:
...
Phase 3 closure remains subject to the final direct immutable-repository
verification gate.

The project shall not reopen substantive Population Package production unless
a specific governance defect or content issue is identified.
...
The minimum Phase 4 context is:
...
**Đây là bộ context tối thiểu mà thread Phase 4 nên đọc trước khi thực hiện PP Integration.**
