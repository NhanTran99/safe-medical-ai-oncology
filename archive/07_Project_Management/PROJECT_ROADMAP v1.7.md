...
The next unresolved architectural boundary is:
...
The gate shall define and approve:

- retrieval-to-runtime evidence boundary;
- Runtime Evidence Package assembly semantics;
- Navigation Context relationship;
- provenance and evidence traceability;
- compatibility with OUTPUT_CONTRACT;
- explicit exclusions from generation and validation.

No implementation of this boundary shall begin before the gate is approved.
