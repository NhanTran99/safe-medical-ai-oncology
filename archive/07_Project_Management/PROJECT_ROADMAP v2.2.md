...
Track 3 Strategy / Scope Review

Track 3 shall first determine, at the governance/architecture level:

- whether governed clinical artifact content should be carried into
  the generation path;
- the minimum contract changes required, if any;
- the governed prompting/content-construction boundary;
- whether a concrete LLM provider should be selected and implemented;
- the minimum vertical-slice acceptance criteria required to demonstrate
  a substantive evidence-grounded chatbot answer.

No Track 3 implementation is authorized until the relevant strategy and
scope decisions are approved and locked.
