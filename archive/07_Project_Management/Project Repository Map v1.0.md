**Project Repository Map v1.0 / handover context** cho các thread sau.
...
Tại thời điểm này, một thread mới chuyển sang Phase 4 nên hiểu:
...
### Phase 4 chuẩn bị bắt đầu

Trọng tâm chuyển từ:

> **“Can we produce a governed PP?”**

sang:

> **“Can all governed PPs be correctly integrated into the Clinical Knowledge Repository and verified for Layer 4?”**

Do đó các materials quan trọng nhất cho thread Phase 4 sẽ là:
