...
The Evidence Package is the standardized output of the RAG subsystem.
...
The Evidence Package is an internal architectural artifact consumed by downstream response generation.
